...
| Claims review FTE headcount | 20 review staff (CFO email Exchange 1; James Liu Exchange 3 — note: inconsistency between 8 FTE reduction per CFO and 13 FTE reduction per James Liu; see A-C1-8) | 7 review staff (James Liu, Exchange 3) | HR headcount record for claims review role classification | 6 months post-go-live |
...
| Cost per adjudicated claim (operational cost) | Derived baseline: ~$29.75/claim (20 staff × $50/hr fully-loaded estimate × 8 hrs ÷ 270 claims/day processed manually — assumption A-C1-9; full derivation in `Deliverables/D2D_token_economics_model.md`) | Target: ≤$5/claim blended (admin path agent-processed + clinical path physician-assisted) — derived from D2D economics model | Finance reporting: total adjudication operating cost ÷ total claims adjudicated, 30-day rolling | 12 months post-go-live |
| Regulatory compliance — HIPAA / URAC accreditation | Current accreditation maintained; HIPAA compliance assumed (not stated in scenario — assumption A-C1-9) | Zero HIPAA breach events; URAC accreditation maintained through and after go-live | External audit: annual URAC re-accreditation; HIPAA incident log (0 events) | Continuous post-go-live |
...
> **Assumption [A-C1-8]:** The target FTE reduction figure is ambiguous between two scenario sources: Sarah Chen (CFO, Exchange 1) implies an 8-person reduction (from 20 to 12), while James Liu (VP Operations, Exchange 3) states a target of 7 review staff — a 13-person reduction. The Section 4a metric uses James Liu's 7-staff target as the operative figure because it is the more specific and recent statement, but the discrepancy is unresolved.
> **Why it matters:** The FTE target determines the headcount reduction commitment in the CFO's business case and affects the ROI timeline in D2D. An 8-person vs. 13-person reduction is a 62% difference in labour cost savings.
> **If wrong:** If the CFO's 8-person reduction is the binding commitment, the labour cost savings are lower and the payback period extends. This must be resolved with Sarah Chen and James Liu before go-live staffing plans are finalised.
> **Confidence:** Low — two directly contradictory figures in the scenario; no reconciliation provided.

---

> **Assumption [A-C1-9]:** Two baselines not stated in scenario_context.md are used in the §4a metrics: (1) Fully-loaded staff cost estimated at $50/hr per claims reviewer for cost-per-claim baseline derivation — consistent with US healthcare payer operations roles but not confirmed. (2) Greenfield currently holds URAC accreditation and maintains HIPAA compliance — both are standard requirements for a commercial health insurance payer but are not stated explicitly in the scenario.
> **Why it matters:** The cost-per-claim baseline (~$29.75) is the denominator for the ROI case. If the true fully-loaded cost is materially different, the cost reduction target changes. If Greenfield does not currently hold URAC accreditation, the compliance metric in §4a needs to be reframed as an acquisition target rather than a maintenance target.
> **If wrong:** Confirm fully-loaded staff cost with Sarah Chen (CFO). Confirm URAC accreditation status with James Liu or the compliance team before finalising the compliance success metric.
> **Confidence:** Medium for URAC/HIPAA (standard for this type of payer); Low for staff cost figure (not stated in scenario).
