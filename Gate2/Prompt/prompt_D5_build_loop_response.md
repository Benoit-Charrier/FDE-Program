...
- Your D4 specs (`Deliverables/D4_agent_purpose_document.md`)
- The D5B build-loop output (`Deliverables/build_loop_analysis.md`) — what was built, questions the builder raised, what could not be built due to spec gaps; this is the raw material for the signal inventory in §1
